...
public static class SeedData
{
    ...
    private static void AddDefaultRoles(BenimContext context)
    {
        ...
        context.Roles.Add(Role.CreateRole("Admin", "Administrator role has access to all permissions."));
        context.Roles.Add(Role.CreateRole("User", "User role has limited permissions."));
        context.SaveChanges();
    }
